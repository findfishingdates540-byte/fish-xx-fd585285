-- Create optimized function to fetch all dating conversations in a single query
...
-- Create optimized function to fetch all buddy conversations in a single query
