  ...
  try {
    ...
    try {
      const emailHtml = `
        ...
        <body style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <div style="background: #f9fafb; padding: 30px; border: 1px solid #e5e7eb;">
            <p>Hi ${safeName},</p>
            <p>Thank you for contacting Fish-X!</p>
            ...
            <p>Best regards,<br><strong>The Fish-X Team</strong></p>
          </div>
        </body>
        </html>
      `;
      ...
      const emailRes = await fetch("https://api.resend.com/emails", {
        ...
        body: JSON.stringify({
          from: "Fish-X <onboarding@resend.dev>",
          to: [email],
        ...
        <body style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <div style="background: #f9fafb; padding: 30px; border: 1px solid #e5e7eb;">
            ...
            <p style="text-align: center;">
              <a href="https://fish-x.com/admin/support" style="display: inline-block; background: #0ea5e9; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold;">View in Admin Panel</a>
            </p>
          </div>
        </body>
        </html>
