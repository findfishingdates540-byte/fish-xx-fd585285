        ...
        <table role="presentation" cellpadding="0" cellspacing="0" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
          ...
          <tr>
            <td style="background-color: #F9FAFB; padding: 24px 40px; border-top: 1px solid #E5E7EB;">
              <p style="margin: 0; font-size: 12px; color: #9CA3AF; text-align: center;">© ${new Date().getFullYear()} Fish-X. All rights reserved.</p>
              <p style="margin: 8px 0 0; font-size: 11px; color: #9CA3AF; text-align: center;">You're receiving this because you signed up for Fish-X.</p>
            </td>
          </tr>
        </table>
      </td>
