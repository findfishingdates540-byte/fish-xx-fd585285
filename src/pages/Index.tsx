...
const heroFishing1 = realPhoto(0);
const heroFishing2 = realPhoto(1);
const heroFishing3 = realPhoto(2);
const fishingBuddies1 = realPhoto(3);
const fishingBuddies2 = realPhoto(4);
const fishingPhoto1 = realPhoto(5);
const fishingPhoto2 = realPhoto(6);
const fishingPhoto3 = realPhoto(7);
const fishingPhoto4 = realPhoto(8);
const fishingPhoto5 = realPhoto(9);
const fishingPhoto6 = realPhoto(10);
const fishingPhoto7 = realPhoto(11);
