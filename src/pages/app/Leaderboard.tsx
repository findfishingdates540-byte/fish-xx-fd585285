            ...
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex rounded-lg overflow-hidden border border-border">
                {["pro", "intermediate", "beginner"].map((level) => (
                  <button key={level} onClick={() => setTeamSkillFilter(level)} className={`px-3 py-1.5 text-xs font-medium transition-colors capitalize ${teamSkillFilter === level ? "bg-primary text-primary-foreground" : "bg-background text-muted-foreground hover:text-foreground"}`}>
