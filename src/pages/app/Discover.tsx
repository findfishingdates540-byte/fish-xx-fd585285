          ...
          <div className="flex-1 flex flex-col items-center justify-center p-4 lg:p-6 min-h-0 overflow-hidden">
            {isLoading ? (
              ...
              <div className="relative flex flex-col items-center max-w-4xl w-full h-full max-h-full min-h-0">
                ...
                <div className="relative w-full max-w-md lg:max-w-full flex-1 min-h-0 max-h-[calc(100%-10rem)] rounded-3xl overflow-hidden shadow-lg">
                ...
                <div className="w-full flex items-center justify-between px-4 mt-2 flex-shrink-0">
