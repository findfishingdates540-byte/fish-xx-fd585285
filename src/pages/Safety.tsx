...
const Safety = () => {
  ...
  const faqs = [
    ...
    { question: 'Can I report anonymously?', answer: 'Yes, all reports are confidential. The reported user is never told who reported them. You can also email safety@fish-x.com for sensitive issues if you prefer not to use in-app reporting.', category: 'reporting' },
