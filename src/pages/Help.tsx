...
const Help = () => {
  ...
  const faqs = {
    ...
    technical: [
      ...
      { question: 'How do I clear the app cache?', answer: 'On iOS: Delete and reinstall the app. On Android: Settings → Apps → Find Fishing Dates → Storage → Clear Cache. This can resolve many display and performance issues.' },
      { question: 'How do I update the app?', answer: 'iOS: App Store → Profile → Find Fishing Dates → Update. Android: Play Store → My Apps → Find Fishing Dates → Update. We recommend enabling auto-updates for the best experience.' },
      ...
      { question: 'How do I report a bug?', answer: 'Email support@findfishingdates.com with: device model, OS version, app version, description of the issue, and screenshots/videos if possible. The more detail you provide, the faster we can fix it.' }
    ],
    trips: [
