...
import ScoringExamples from "./pages/app/ScoringExamples";
...
import TeamPageMessages from "./pages/app/TeamPageMessages";
import TeamPageInbox from "./pages/app/TeamPageInbox";
...
<Route path="messages" element={<DatingRoute><Messages /></DatingRoute>}>
              ...
              <Route element={<FishingRoute><ScoreboardHubLayout /></FishingRoute>}>
                ...
                <Route path="scoring-examples" element={<ScoringExamples />} />
                ...
                <Route path="teams/:teamId/messages" element={<TeamPageMessages />} />
                <Route path="teams/:teamId/inbox" element={<TeamPageInbox />} />
